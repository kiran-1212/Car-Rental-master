					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['client_id'];?>)" class="ico del">Approve</a><a href="delete.php" class="ico edit">Delete</a></td>
							</tr>
							<?php
								}
							?>
...
<div id="footer">
	<div class="shell">
		<span class="left">&copy; <?php echo date("Y");?> - VRS</span>
		<span class="right">
			Design by <a href="#">VRS</a>
		</span>
	</div>
</div>
<!-- End Footer -->
